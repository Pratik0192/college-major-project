              ...
              products.map((product, index) => (
                <tr key={product._id} className="odd:bg-gray-100 even:bg-white text-center hover:bg-gray-200 transition">
                  ...
                  <td className="p-3 border border-gray-300">
                    <img className="w-12 h-12 object-cover mx-auto rounded-md" src={product.image[0]} alt={product.name} />
                  </td>
                  <td className="p-3 border border-gray-300">
                  ...
                  <td className="p-3 border border-gray-300">{currency}{product.price}</td>
