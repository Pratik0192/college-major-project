...
const registerUser = async(req, res) => {
  try {
    ...
    const verifyEmail = await sendEmail({
      sendTo: email,
      subject: "Verification email from OptiVerse2.0",
...
const forgotPasswordController = async(req, res) => {
  try {
    ...
    await sendEmail({
      sendTo: email,
      subject: "Forgot Password - OptiVerse2.0",
...
export { loginUser, registerUser, adminLogin, verifyEmailController, forgotPasswordController, verifyForgotPasswordOtp, resetPassword , getAllUsers }