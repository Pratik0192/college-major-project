...
const ShopContextProvider = (props) => {
  ...
  const navigate = useNavigate();// for search input
  ...
  const removeWishlist = async (itemId) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // ✅ Refresh wishlist correctly
        const updatedWishlist = await getWishlistedItems(token);
        setWishlistItems(updatedWishlist); // make sure you're setting it here
